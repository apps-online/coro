...
class AppLogger
{
    ...
    {
        if (! is_null(\Coro\AppCore::registry('ip'))) {
            $addressIp = \Coro\AppCore::registry('ip');
        } else {
            $addressIp = '127.0.0.1';
        }
    ...
    {
        if (! is_null(\Coro\AppCore::registry('sIp'))) {
            $addressIp = \Coro\AppCore::registry('sIp');
        } else {
            $addressIp = '127.0.0.1';
        }
